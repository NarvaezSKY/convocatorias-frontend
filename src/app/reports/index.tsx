    ...
    <DefaultLayout>
      <div className="flex w-full items-center justify-center flex-col gap-2">
        <iframe
          ...
          width="100%"
         />
        <Link color="success" href="https://app.powerbi.com/view?r=eyJrIjoiMDFjNjUzMTAtMjdhOS00YTQ2LTk0MmUtMzRmNDc2MTY2ZmI2IiwidCI6ImNiYzJjMzgxLTJmMmUtNGQ5My05MWQxLTUwNmM5MzE2YWNlNyIsImMiOjR9">
